...
func TestAccumulateObjectSummaryClassifiesEveryTerminalProjection(t *testing.T) {
	...
	objects := []ObjectResult{
		...
		{Bytes: 8, Disposition: ObjectDispositionRegistered},
		{Bytes: 9, Disposition: ObjectDispositionUnattempted},
	}
	...
	want := ObjectSummary{
		Total: 9, Bytes: 45, Ingested: 1, Resumed: 1, Rejected: 1, Retracted: 1,
		Stranded: 2, Unattempted: 3, Verified: 2, StorageVerified: 1, ReadbackVerified: 1,
	}
	if summary != want {
